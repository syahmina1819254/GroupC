...
import { Container, Content, Button, Icon, Text, Form, Item, Label, Input, Picker } from 'native-base';
      ...
      <View style={styles.container}>
        ...
        <View style={styles.box}>
                   ...
                   <Picker
                            ...
                            onValueChange={(itemValue, itemIndex) => this.setOrganisation({ Organisation: itemValue })}>
        ...
        <View style={styles.box}>            
                  <Picker
                            ...
                            style={{ height: 50, width: 350 }}
                            onValueChange={(itemValue) => this.setPaymentMethod({ PaymentMethod: itemValue })}>
