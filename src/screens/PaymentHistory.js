...
import { removeDonation } from '../services/DataServices';
import { Alert,View,StyleSheet} from 'react-native';
import { Content, Text, List, Container } from 'native-base';
  ...
  render() {
    ...
    return (
      <View style={styles.container}>
        ...
        <Container>
        <List vertical={true}>
        <PaymentList Donation={this.state.Donation} onLongPress={(DonationID) => {this.deleteConfirmation(DonationID)}} />
        </List>
